          ...
          <div class="sidebarMenuScroll">
            <ul class="sidebar-menu">
              ...
              <li class="treeview active">
                ...
                <ul class="treeview-menu">
                  <li>
                    <a href="accordions.go" class="active active-sub">Accordions</a>
                  </li>
                  <li>
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <ol class="breadcrumb d-none d-lg-flex ms-3">
              ...
              <li class="breadcrumb-item text-secondary">Accordions</li>
            </ol>
            <!-- Breadcrumb end -->
                          ...
                          <div id="collapseSpecialTitleOne" class="accordion-collapse collapse show"
                            ...
                            <div class="accordion-body">
                              ...
                              <h5 class="mb-3 fw-light lh-lg">
                                ...
                                about any .go can go within the
                          ...
                          <div id="collapseSpecialTitleThree" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body">
                              <h5 class="mb-3 fw-light lh-lg">
                                ...
                                just about any .go can go within the
                                <code>.accordion-body</code>, though the
                                transition does limit overflow.
                              </h5>
                            </div>
