            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview active">
                ...
                <ul class="treeview-menu">
                  ...
                  <li>
                    <a href="alerts.go" class="active active-sub">Alerts</a>
                  </li>
                  <li>
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <ol class="breadcrumb d-none d-lg-flex ms-3">
              ...
              <li class="breadcrumb-item text-secondary">Alerts</li>
            </ol>
            <!-- Breadcrumb end -->
                  ...
                  <div class="card">
                    <div class="card-body">
                      <div class="alert alert-primary rounded-3" role="alert">
                        <div class="mb-3">
                          <i class="bi bi-bullseye fs-1 me-2 lh-1"></i>
                        </div>
                        <h4>Primary!</h4>
                        <p>
                      ...
                      <div class="alert alert-secondary rounded-3" role="alert">
                        <div class="mb-3">
                          <i class="bi bi-app-indicator fs-1 me-2 lh-1"></i>
                        </div>
                        <h4>Secondary!</h4>
                        <p>
                          Aww yeah, you successfully read this important alert
