            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview active">
                ...
                <ul class="treeview-menu">
                  ...
                  <li>
                    <a href="calendar-list-view.go" class="active-sub">List View</a>
                  </li>
                  <li>
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <ol class="breadcrumb d-none d-lg-flex ms-3">
              ...
              <li class="breadcrumb-item text-secondary">List View</li>
            </ol>
            <!-- Breadcrumb end -->
                ...
                <div class="col-12">
                  <div class="card">
                    <div class="card-header">
                      <h4 class="card-title">Calendar List View</h4>
                    </div>
                    <div class="card-body">
                      <div id="listView"></div>
                    </div>
