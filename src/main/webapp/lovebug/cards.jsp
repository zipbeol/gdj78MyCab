          ...
          <div class="sidebarMenuScroll">
            <ul class="sidebar-menu">
              ...
              <li class="treeview active">
                ...
                <ul class="treeview-menu">
                  <li>
                    <a href="cards.go" class="active-sub">Cards</a>
                  </li>
                  <li>
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <ol class="breadcrumb d-none d-lg-flex ms-3">
              ...
              <li class="breadcrumb-item text-secondary">Bootstrap Cards</li>
            </ol>
            <!-- Breadcrumb end -->
            ...
            <div class="container-fluid">
              ...
              <div class="row gx-4">
                <div class="col-sm-6 col-12">
                  <div class="card mb-4">
                    <div class="card-header">
                      <h5 class="card-title text-warning">Card Header</h5>
                    </div>
                    <div class="card-body">
                      <div class="d-flex">
                ...
                <div class="col-sm-6 col-12">
                  <div class="card mb-4">
                    <div class="card-header">
                      <h5 class="card-title text-info">Card Header</h5>
                    </div>
                    <div class="card-body">
                      <div class="d-flex">
              ...
              <div class="row gx-4">
                ...
                <div class="col-sm-6 col-12">
                  <div class="card mb-4">
                    <div class="card-header">
                      <h5 class="card-title text-success mb-2">Card Title</h5>
                      <div class="card-subtitle">Card Sub Title</div>
                    </div>
                    <div class="card-body">
                      <p>
                        Some quick example text to build on the card title and
                ...
                <div class="col-sm-6 col-12">
                  <div class="card mb-4">
                    <div class="card-header">
                      <h5 class="card-title text-danger mb-2">Card Title</h5>
                      <div class="card-subtitle">Card Sub Title</div>
                    </div>
                    <div class="card-body">
                      <p>
                ...
                <div class="col-sm-4 col-12">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <a href="#" class="btn btn-outline-warning">More</a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="row row-cols-1 row-cols-lg-3 align-items-stretch g-4">
                <div class="col">
                  <div class="card card-cover mb-4" style="
                    ...
                    <div class="backdrop-blur">
                      <div class="p-5 text-white">
                        <h4 class="display-5 fw-lighter mb-4">
                          Another longer title belongs here
                        </h4>
