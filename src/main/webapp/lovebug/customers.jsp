        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <ol class="breadcrumb d-none d-lg-flex ms-3">
              ...
              <li class="breadcrumb-item text-secondary">Customers</li>
            </ol>
            <!-- Breadcrumb end -->
                      ...
                      <div class="table-outer">
                        <div class="table-responsive">
                          <table class="table align-middle text-nowrap custom-table m-0">
                            ...
                            <tbody>
                              <tr>
                                <td>Kristy Collins</td>
                                <td>info@testing.com</td>
                                <td>999-999-9999</td>
                                <td>Bootstrap Gallery</td>
                                <td>UX Designer</td>
                                <td>California</td>
                                <td>
                                  <div class="d-flex gap-1">
                                    <a href="javascript:void(0)">
                                      <img src="assets/images/social/facebook.svg" class="img-1x"
                                        alt="Bootstrap Gallery">
                                    </a>
                                    <a href="javascript:void(0)">
                                      <img src="assets/images/social/twitter.svg" class="img-1x"
                                        alt="Bootstrap Gallery">
                                    </a>
                                    <a href="javascript:void(0)">
                                      <img src="assets/images/social/linkedin.svg" class="img-1x"
                                        alt="Bootstrap Gallery">
                                    </a>
                                  </div>
                                </td>
                              ...
                              <tr>
                                ...
                                <td>
                                  <span class="badge border border-info text-info">Pause</span>
                                </td>
                                <td>
                                  <button class="btn btn-success btn-sm">
                                    Activate
                              ...
                              <tr>
                                ...
                                <td>
                                  <span class="badge border border-danger text-danger">Disabled</span>
                                </td>
                                <td>
                                  <button class="btn btn-success btn-sm">
                                    Activate
