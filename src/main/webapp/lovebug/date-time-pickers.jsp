            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview active">
                ...
                <ul class="treeview-menu">
                  ...
                  <li>
                    <a href="date-time-pickers.go" class="active active-sub">Date Time Pickers</a>
                  </li>
                  <li>
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <ol class="breadcrumb d-none d-lg-flex ms-3">
              ...
              <li class="breadcrumb-item text-secondary">Date Time Pickers</li>
            </ol>
            <!-- Breadcrumb end -->
              ...
              <div class="row gx-3">
                <div class="col-sm-4 col-12">
                  ...
                  <div class="card mb-3">
                    <div class="card-body">
                      <div class="m-0">
                        <div class="form-label">Custom Date Range</div>
                ...
                <div class="col-sm-4 col-12">
                  ...
                  <div class="card mb-3">
                    <div class="card-body">
                      <div class="m-0">
                        <div class="form-label">Custom Date Range Auto</div>
                        <div class="input-group">
                ...
                <div class="col-sm-4 col-12">
                  ...
                  <div class="card mb-3">
                    <div class="card-body">
                      <div class="m-0">
                        <div class="form-label">Week Numbers</div>
                        <div class="input-group">
                ...
                <div class="col-sm-4 col-12">
                  ...
                  <div class="card mb-3">
                    <div class="card-body">
                      <div class="m-0">
                        <div class="form-label">ISO Week Numbers</div>
                        <div class="input-group">
                ...
                <div class="col-sm-4 col-12">
                  ...
                  <div class="card mb-3">
                    <div class="card-body">
                      <div class="m-0">
                        <div class="form-label">Datepicker 24 Hours Time</div>
                        <div class="input-group">
                ...
                <div class="col-sm-4 col-12">
                  ...
                  <div class="card mb-3">
                    <div class="card-body">
                      <div class="m-0">
                        <div class="form-label">Datepicker Range</div>
                        <div class="input-group">
                ...
                <div class="col-sm-4 col-12">
                  ...
                  <div class="card mb-3">
                    <div class="card-body">
                      <div class="m-0">
                        <div class="form-label">Datepicker Time Seconds</div>
                        <div class="input-group">
                ...
                <div class="col-sm-4 col-12">
                  ...
                  <div class="card mb-3">
                    <div class="card-body">
                      <div class="m-0">
                        <div class="form-label">Date Range Auto Apply</div>
                        <div class="input-group">
                ...
                <div class="col-sm-4 col-12">
                  ...
                  <div class="card mb-3">
                    <div class="card-body">
                      <div class="m-0">
                        <div class="form-label">Range Week Numbers</div>
                        <div class="input-group">
                ...
                <div class="col-sm-4 col-12">
                  ...
                  <div class="card mb-3">
                    <div class="card-body">
                      <div class="m-0">
                        <div class="form-label">Range ISO Week Numbers</div>
                        <div class="input-group">
                ...
                <div class="col-sm-4 col-12">
                  ...
                  <div class="card mb-3">
                    <div class="card-body">
                      <div class="m-0">
                        <div class="form-label">Datepicker Range Time</div>
                        <div class="input-group">
                ...
                <div class="col-sm-4 col-12">
                  ...
                  <div class="card mb-3">
                    <div class="card-body">
                      <div class="m-0">
                        <div class="form-label">Date Range Opens Right</div>
                        <div class="input-group">
                ...
                <div class="col-sm-4 col-12">
                  ...
                  <div class="card mb-3">
                    <div class="card-body">
                      <div class="m-0">
                        <div class="form-label">Date Range Opens Top Left</div>
                        <div class="input-group">
                ...
                <div class="col-sm-4 col-12">
                  ...
                  <div class="card mb-3">
                    <div class="card-body">
                      <div class="m-0">
                        <div class="form-label">Date Range Opens Left</div>
                        <div class="input-group">
