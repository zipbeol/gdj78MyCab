                      ...
                      <div class="border rounded-3 p-5">
                        ...
                        <div class="mb-5">
                          ...
                          <p class="mb-3">
                            ...
                            <a href="#!" class="text-primary">Contact our support</a>
                          </p>
                                ...
                                <div class="accordion" id="accordionFaq">
                                  <div class="accordion-item">
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse show"
                                      ...
                                      <div class="accordion-body">
                                        ...
                                        admin dashboards, including multipurpose
                                        and responsive landing pages and .go
                                        templates.
                                      </div>
                                    </div>
                                  </div>
                                  <div class="accordion-item">
                                    ...
                                    <div id="collapseTwo" class="accordion-collapse collapse"
                                      ...
                                      <div class="accordion-body">
                                        ...
                                        premium Bootstrap based admin
                                        dashboards, admin themes and admin
                                        templates.
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <div class="accordion-item">
                                    ...
                                    <div id="collapseFour" class="accordion-collapse collapse"
                                      ...
                                      <div class="accordion-body">
                                        Quality admin dashboards and admin
                                        themes available at reasonable price.
                                      </div>
                                    </div>
                                  </div>
                                </div>
                        ...
                        <!-- Chat start -->
                        <div class="text-center pt-5 border border-dark p-3 w-50 rounded-3 mt-5 m-auto">
                          <h3 class="text-black">
                            Still canât find your answer?
                          </h3>
                          <p class="fw-300">We are happy to help!</p>
