            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview active">
                ...
                <ul class="treeview-menu">
                  ...
                  <li>
                    <a href="list-items.go" class="active active-sub">List Items</a>
                  </li>
                  <li>
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <ol class="breadcrumb d-none d-lg-flex ms-3">
              ...
              <li class="breadcrumb-item text-secondary">List Items</li>
            </ol>
            <!-- Breadcrumb end -->
                    ...
                    <div class="card-body">
                      <div class="list-group w-auto">
                        <a href="#" class="list-group-item list-group-item-action d-flex gap-3 py-3"
                          aria-current="true">
                          <img src="/assets/images/brand-google.svg" alt="Bootstrap Gallery"
                            class="rounded-circle flex-shrink-0 img-3x">
                          ...
                          <div class="d-flex gap-2 w-100 justify-content-between">
                            <div>
                              ...
                              <p class="mb-0 opacity-75">
                                ...
                                goes a little longer so it wraps to a new line.
                              </p>
                            </div>
                  ...
                  <div class="card mb-3">
                    <div class="card-body">
                      <ul class="list-group">
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                          A list item
                          <span class="badge border border-info text-info">14</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                          A second list item
                          <span class="badge border border-danger text-danger">14</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                          A third list item
                          <span class="badge border border-success text-success">14</span>
                        </li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div class="card mb-3">
                    <div class="card-body">
                      <ul class="list-group list-group-numbered">
                        <li class="list-group-item">An item number</li>
                        <li class="list-group-item">A second item number</li>
                        <li class="list-group-item">A third item number</li>
                      </ul>
                    </div>
                  </div>
                  <!-- Card end -->
