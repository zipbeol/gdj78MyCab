...
<html lang="ko">
  ...
  <body>
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <ol class="breadcrumb d-none d-lg-flex ms-3">
              ...
              <li class="breadcrumb-item text-secondary">Maps</li>
            </ol>
            <!-- Breadcrumb end -->
                ...
                <div class="col-xxl-12">
                  <div class="card mb-3">
                    <div class="card-body p-5">
                      <div id="world-map-markers2" class="chart-height-xxl position-relative"></div>
                    </div>
                  </div>
                </div>
                <div class="col-xxl-12">
                  <div class="card mb-3">
                    <div class="card-body p-5">
                      <div id="world-map-gdp" class="chart-height-xxl position-relative"></div>
                    </div>
                  </div>
                </div>
                <div class="col-xxl-6">
                  <div class="card mb-3">
                    <div class="card-body p-5">
                      <div id="mapDenmark" class="chart-height-xxl"></div>
                    </div>
                  </div>
                </div>
                <div class="col-xxl-6">
                  <div class="card mb-3">
                    <div class="card-body p-5">
                      <div id="mapAfrica" class="chart-height-xxl"></div>
                    </div>
                  </div>
                </div>
                <div class="col-xxl-6">
                  <div class="card mb-3">
                    <div class="card-body p-5">
                      <div id="us-map2" class="chart-height-xxl"></div>
                    </div>
                  </div>
                </div>
                <div class="col-xxl-6">
                  <div class="card mb-3">
                    <div class="card-body p-5">
                      <div id="us-map3" class="chart-height-xxl"></div>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <script src="assets/vendor/jvectormap/dk-mill.js"></script>
    ...
    <script src="assets/vendor/jvectormap/custom/world-map-gdp.js"></script>
    ...
    <script src="assets/vendor/jvectormap/custom/custom-denmark.js"></script>
