            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview active">
                ...
                <ul class="treeview-menu">
                  ...
                  <li>
                    <a href="morris.go" class="active-sub">Morris</a>
                  </li>
                </ul>
              </li>
              <li>
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <ol class="breadcrumb d-none d-lg-flex ms-3">
              ...
              <li class="breadcrumb-item text-secondary">Morris Graphs</li>
            </ol>
            <!-- Breadcrumb end -->
              ...
              <div class="row gx-3">
                <div class="col-xl-6">
                  <div class="card mb-3">
                    <div class="card-header">
                      <h5 class="card-title">Line Negative Values</h5>
                    </div>
                    <div class="card-body">
                      <div id="negativeValues" class="chart-height-xl"></div>
                    </div>
                  </div>
                </div>
                <div class="col-xl-6">
                  <div class="card mb-3">
                    ...
                    <div class="card-body">
                      <div id="stackedBar" class="chart-height-xl"></div>
                    </div>
                  </div>
                </div>
                <div class="col-xl-12">
                ...
                <div class="col-xl-6">
                  <div class="card mb-3">
                    ...
                    <div class="card-body">
                      <div id="barColors" class="chart-height-xl"></div>
                    </div>
                  </div>
                </div>
                <div class="col-xl-6">
                  <div class="card mb-3">
                    <div class="card-header">
                      <h5 class="card-title">Day Data</h5>
                    </div>
                    <div class="card-body">
                ...
                <div class="col-xl-6">
                  <div class="card mb-3">
                    ...
                    <div class="card-body">
                      <div id="donutColors" class="chart-height-xl"></div>
                    </div>
                  </div>
                </div>
                <div class="col-xl-6">
                  <div class="card mb-3">
                    <div class="card-header">
                      <h5 class="card-title">Donut Format</h5>
                    </div>
                    <div class="card-body">
                ...
                <div class="col-xl-12">
                  <div class="card mb-3">
                    ...
                    <div class="card-body">
                      <div id="morrisBar" class="chart-height-xl"></div>
                    </div>
                  </div>
                </div>
              </div>
