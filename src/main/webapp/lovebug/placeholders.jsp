            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview active">
                ...
                <ul class="treeview-menu">
                  ...
                  <li>
                    <a href="placeholders.go" class="active active-sub">Placeholders</a>
                  </li>
                  <li>
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <ol class="breadcrumb d-none d-lg-flex ms-3">
              ...
              <li class="breadcrumb-item text-secondary">Placeholders</li>
            </ol>
            <!-- Breadcrumb end -->
          ...
          <div class="app-body">
            ...
            <div class="container-fluid">
              ...
              <div class="row gx-3">
                <div class="col-sm-4">
                  <div class="card mb-3">
                    <img src="/assets/images/placeholder.svg" class="card-img-top placeholder" alt="Bootstrap Gallery">
                    <div class="card-body">
                      <h5>Header</h5>
                      <p>
                ...
                <div class="col-sm-4">
                  <div class="card mb-4" aria-hidden="true">
                    <img src="/assets/images/placeholder.svg" class="card-img-top placeholder" alt="Bootstrap Gallery">
                    <div class="card-body">
                      <h5 class="placeholder-glow">Header</h5>
                      ...
                      <a href="javascript:void(0)" class="btn btn-primary disabled placeholder col-6"></a>
                    </div>
                  </div>
                </div>
                <div class="col-sm-4">
                  <div class="card mb-4" aria-hidden="true">
                    ...
                    <div class="card-body">
                      ...
                      <p class="placeholder-glow">
                        ...
                        <span class="placeholder bg-danger col-4"></span>
                        <span class="placeholder bg-success col-4"></span>
                        <span class="placeholder bg-warning col-6"></span>
                        <span class="placeholder col-8"></span>
                      </p>
                      <a href="javascript:void(0)" class="btn btn-primary disabled placeholder col-6"></a>
                    </div>
                ...
                <div class="col-12">
                  <div class="card mb-3">
                    <div class="card-header">
                      <h5 class="card-title">Placeholder Color</h5>
                    </div>
                    <div class="card-body">
              ...
              <div class="row gx-3">
                <div class="col-12">
                  <div class="card mb-3">
                    <div class="card-header">
                      <h5 class="card-title">Placeholder Sizing</h5>
                    </div>
                    <div class="card-body">
