            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview active">
                ...
                <ul class="treeview-menu">
                  ...
                  <li>
                    <a href="progress.go" class="active active-sub">Progress Bars</a>
                  </li>
                  <li>
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <ol class="breadcrumb d-none d-lg-flex ms-3">
              ...
              <li class="breadcrumb-item text-secondary">Progress Bars</li>
            </ol>
            <!-- Breadcrumb end -->
              ...
              <div class="row gx-3">
                <div class="col-xxl-12">
                  <div class="card mb-3">
                    <div class="card-body">
                      <div class="d-flex">
                        <div class="progress progress-vertical thin">
                          <div class="progress-bar bg-secondary" role="progressbar" style="height: 10%"
                            aria-valuenow="10" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <div class="m-3"></div>
                        <div class="progress progress-vertical small">
                          <div class="progress-bar bg-dark" role="progressbar" style="height: 20%" aria-valuenow="20"
                            aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <div class="m-3"></div>
                        <div class="progress progress-vertical medium">
                          <div class="progress-bar bg-success" role="progressbar" style="height: 30%" aria-valuenow="30"
                            aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <div class="m-3"></div>
                        <div class="progress progress-vertical lg">
                          <div class="progress-bar bg-info" role="progressbar" style="height: 40%" aria-valuenow="40"
                            aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <div class="m-3"></div>
                        <div class="progress progress-vertical xl">
                          <div class="progress-bar bg-warning" role="progressbar" style="height: 50%" aria-valuenow="50"
                        ...
                        <div class="m-3"></div>
                        <div class="progress progress-vertical xl">
                          <div class="progress-bar bg-danger" role="progressbar" style="height: 60%" aria-valuenow="60"
                            aria-valuemin="0" aria-valuemax="100">
                            60%
                          </div>
                        </div>
                        <div class="m-3"></div>
                        <div class="progress progress-vertical xl">
                          <div class="progress-bar" role="progressbar" style="height: 70%" aria-valuenow="70"
                            aria-valuemin="0" aria-valuemax="100">
                            70%
                          </div>
                        </div>
                        <div class="m-3"></div>
                        <div class="progress progress-vertical xl">
                          <div class="progress-bar bg-success" role="progressbar" style="height: 80%" aria-valuenow="80"
                            aria-valuemin="0" aria-valuemax="100">
                            80%
                          </div>
                        </div>
