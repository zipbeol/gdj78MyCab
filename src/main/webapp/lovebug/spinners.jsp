            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview active">
                ...
                <ul class="treeview-menu">
                  ...
                  <li>
                    <a href="spinners.go" class="active active-sub">Spinners</a>
                  </li>
                  <li>
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <ol class="breadcrumb d-none d-lg-flex ms-3">
              ...
              <li class="breadcrumb-item text-secondary">Spinners</li>
            </ol>
            <!-- Breadcrumb end -->
              ...
              <div class="row gx-3">
                ...
                <div class="col-sm-4 col-12">
                  <div class="card mb-3">
                    <div class="card-body">
                      <div class="d-flex align-items-center">
                        <div class="spinner-border text-info me-auto" role="status" aria-hidden="true"></div>
                        <strong>Loading...</strong>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-lg-6 col-sm-12 col-12">
                  <div class="card mb-3">
                    <div class="card-body">
                      <div class="spinner-border text-primary spinner-w1" role="status"></div>
                      <div class="spinner-border text-danger spinner-w2" role="status"></div>
                      <div class="spinner-border text-info spinner-w3" role="status"></div>
                      <div class="spinner-border text-success spinner-w5" role="status"></div>
                    </div>
                  </div>
                </div>
                <div class="col-lg-6 col-sm-12 col-12">
                  <div class="card mb-3">
                    <div class="card-body">
                      <div class="spinner-grow text-primary spinner-w1" role="status"></div>
                      <div class="spinner-grow text-danger spinner-w2" role="status"></div>
                      <div class="spinner-grow text-info spinner-w3" role="status"></div>
                      <div class="spinner-grow text-success spinner-w5" role="status"></div>
                    </div>
                  </div>
                </div>
                <div class="col-lg-6 col-sm-12 col-12">
