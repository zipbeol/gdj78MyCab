            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview active">
                ...
                <ul class="treeview-menu">
                  ...
                  <li>
                    <a href="tooltips.go" class="active active-sub">Tooltips</a>
                  </li>
                </ul>
              </li>
              <li class="treeview">
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <ol class="breadcrumb d-none d-lg-flex ms-3">
              ...
              <li class="breadcrumb-item text-secondary">Tooltips</li>
            </ol>
            <!-- Breadcrumb end -->
                ...
                <div class="col-xxl-12">
                  <div class="card mb-3">
                    <div class="card-body">
                      ...
                      <button type="button" class="btn btn-warning" data-bs-toggle="tooltip" data-bs-placement="right"
                        data-bs-title="Tooltip on right">
                        Tooltip on right
                      </button>
                      <button type="button" class="btn btn-warning" data-bs-toggle="tooltip" data-bs-.go="true"
                        data-bs-title="<em>Tooltip</em> <u>with</u> <b>.go</b>">
                        Tooltip with .go
                      </button>
                    </div>
                  </div>
                ...
                <div class="col-xxl-12">
                  <div class="card mb-3">
                    <div class="card-body">
                      ...
                      <button type="button" class="btn btn-warning" data-bs-toggle="tooltip" data-bs-placement="right"
                        data-bs-custom-class="custom-tooltip-warning"
                        data-bs-title="This top tooltip is themed via CSS variables.">
