        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <ol class="breadcrumb d-none d-lg-flex ms-3">
              ...
              <li class="breadcrumb-item text-secondary">Events</li>
            </ol>
            <!-- Breadcrumb end -->
                ...
                <div class="col-12">
                  <div class="card">
                    <div class="card-header">
                      <h4 class="card-title">Upcoming Trips List</h4>
                    </div>
                    <div class="card-body">
                      <!-- Buttons start -->
                      ...
                      <div class="mt-4">
                        <div class="list-group">
                          <a href="javascript:void(0)"
                            ...
                            <div class="bg-primary bg-opacity-10 p-3 text-center rounded-2">
                              <h5 class="fw-bold">21</h5>
                              <h6 class="text-uppercase m-0">May</h6>
                            </div>
                            <div class="p-3">
                              <h5>
                                East USA for All 5N | 6D
                              </h5>
                              <p class="m-0">$2500.00 - $3800.00 <span class="small text-secondary">Per Person</span>
                              </p>
                            </div>
                          </a>
                          <a href="javascript:void(0)"
                            ...
                            <div class="p-3">
                              <h5>
                                Best of USA National Parks for All 7N | 8D
                              </h5>
                              <p class="m-0">$2700.00 - $4300.00 <span class="small text-secondary">Per Person</span>
                              </p>
                            </div>
                          </a>
                          <a href="javascript:void(0)"
                            ...
                            <div class="bg-primary bg-opacity-10 p-3 text-center rounded-2">
                              ...
                              <h6 class="text-uppercase m-0">June</h6>
                            </div>
                            <div class="p-3">
                              <h5>
                                Best of Canadian Rockies With Alaskan Cruise 15N | 16D
                              </h5>
                              <p class="m-0">$1400.00 - $2300.00 <span class="small text-secondary">Per Person</span>
                              </p>
                            </div>
                          </a>
                          <a href="javascript:void(0)"
                            ...
                            <div class="p-3">
                              <h5>
                                Eastern Delights with Orlando & Bahamas Cruise 11N | 12D
                              </h5>
                              <p class="m-0">$4900.00 - $7200.00 <span class="small text-secondary">Per Person</span>
                              </p>
                            </div>
                          </a>
                          <a href="javascript:void(0)"
                            ...
                            <div class="p-3">
                              <h5>
                                Super Budget Tour of USA with Orlando 13N | 14D
                              </h5>
                              <p class="m-0">$1900.00 - $2200.00 <span class="small text-secondary">Per Person</span>
                              </p>
                            </div>
                          </a>
                          <a href="javascript:void(0)"
                            ...
                            <div class="bg-primary bg-opacity-10 p-3 text-center rounded-2">
                              ...
                              <h6 class="text-uppercase m-0">July</h6>
                            </div>
                            <div class="p-3">
                              <h5>
                                Grand Bargain America with Add on 4 Nights Cuba 15N | 16D</h5>
                              <p class="m-0">$3100.00 - $3500.00 <span class="small text-secondary">Per Person</span>
                              </p>
                            </div>
                          </a>
                          <a href="javascript:void(0)"
                            ...
                            <div class="p-3">
                              <h5>Bootsrap Gallery Themes and Templates</h5>
                              <p class="m-0">$2100.00 - $3300.00 <span class="small text-secondary">Per Person</span>
                              </p>
                            </div>
                          </a>
                          <a href="javascript:void(0)"
                            ...
                            <div class="bg-primary bg-opacity-10 p-3 text-center rounded-2">
                              <h5 class="fw-bold">10</h5>
                              <h6 class="text-uppercase m-0">Aug</h6>
                            </div>
                            <div class="p-3">
                              <h5>
                                New Highlights of Europe (Summer 2023)
                              </h5>
                              <p class="m-0">$4200.00 - $6400.00 <span class="small text-secondary">Per Person</span>
                              </p>
                            </div>
                          </a>
                          <a href="javascript:void(0)"
                            ...
                            <div class="p-3">
                              <h5>
                                Grand Bargain Tour Of Europe With Versailles And Montmartre - (Summer)
                              </h5>
                              <p class="m-0">$2500.00 - $5500.00 <span class="small text-secondary">Per Person</span>
                              </p>
                            </div>
                          </a>
                        </div>
