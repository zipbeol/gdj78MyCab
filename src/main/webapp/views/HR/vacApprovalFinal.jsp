        ...
        <div class="app-container">
            ...
            <div class="app-header d-flex align-items-center">
                ...
                <ol class="breadcrumb d-none d-lg-flex ms-3">
                    ...
                    <li class="breadcrumb-item">
                        <a href="/emp/vac/finalList.go" class="text-decoration-none">연차 승인 및 반려</a>
                    </li>
                </ol>
                <!-- Breadcrumb end -->
...
$(document).ready(function(){
 ...
 // 신청리스트 호출
    ...
    function getTotalPages() {
        getSearchValue();
        $.ajax({
            url: '/getVacFinalTotalPages.ajax',
            type: 'GET',
            data: {
            	 'filterVacResult': filterVacResult,
                 'filterVacDate':filterVacDate
    ...
    function drawList(list) {
        ...
        $(document).on('click', '.total-vac-list-tbody-tr', function () {
        	location.href = '/vacApprovalFinalDetail.go?vac_no=' + $(this).attr('id');
        });
    }
