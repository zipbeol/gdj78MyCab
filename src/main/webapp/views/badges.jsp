            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview active">
                ...
                <ul class="treeview-menu">
                  ...
                  <li>
                    <a href="badges.go" class="active active-sub">Badges</a>
                  </li>
                  <li>
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <ol class="breadcrumb d-none d-lg-flex ms-3">
              ...
              <li class="breadcrumb-item text-secondary">Badges</li>
            </ol>
            <!-- Breadcrumb end -->
                      ...
                      <div class="row gx-3">
                        ...
                        <div class="col-xxl-12">
                          ...
                          <div class="card mb-3">
                            <div class="card-body">
                              <div class="d-inline-flex gap-3 flex-wrap">
                                <span class="badge bg-primary"><i class="bi bi-caret-up-fill"></i>
                                  Primary</span>
                                <span class="badge bg-secondary"><i class="bi bi-caret-down-fill"></i>
                                  Secondary</span>
                                <span class="badge bg-success"><i class="bi bi-caret-right-fill"></i>
                                  Success</span>
                                <span class="badge bg-danger"><i class="bi bi-caret-left-fill"></i>
                                  Danger</span>
                                ...
                                <span class="badge bg-light text-dark"><i
                                    class="bi bi-caret-right-fill"></i>Light</span>
                                <span class="badge bg-dark"><i class="bi bi-caret-left-fill"></i>
                                  Dark</span>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="card mb-3">
                            <div class="card-body">
                              <button type="button" class="btn btn-outline-primary position-relative">
                                Inbox
                                <span
                                  class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-primary">10+</span>
                              </button>
                            </div>
                          </div>
                          <!-- Card end -->
