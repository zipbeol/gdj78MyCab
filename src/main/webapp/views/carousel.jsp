            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview active">
                ...
                <ul class="treeview-menu">
                  ...
                  <li>
                    <a href="carousel.go" class="active active-sub">Carousel</a>
                  </li>
                  <li>
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <ol class="breadcrumb d-none d-lg-flex ms-3">
              ...
              <li class="breadcrumb-item text-secondary">Carousel</li>
            </ol>
            <!-- Breadcrumb end -->
                      ...
                      <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                          <div class="carousel-item active">
                            <img src="assets/images/products/product5.jpg" class="d-block w-100"
                              alt="Bootstrap Gallery">
                          </div>
                          <div class="carousel-item">
                            <img src="assets/images/products/product1.jpg" class="d-block w-100"
                              alt="Bootstrap Gallery">
                          </div>
                          <div class="carousel-item">
                            <img src="assets/images/products/product6.jpg" class="d-block w-100"
                              alt="Bootstrap Gallery">
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="card mb-3">
                    <div class="card-body">
                      <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                          <div class="carousel-item active">
                            <img src="assets/images/products/product7.jpg" class="d-block w-100"
                              alt="Bootstrap Gallery">
                          </div>
                          <div class="carousel-item">
                            <img src="assets/images/products/product5.jpg" class="d-block w-100"
                          ...
                          <div class="carousel-item">
                            <img src="assets/images/products/product8.jpg" class="d-block w-100"
                              alt="Bootstrap Gallery">
                          </div>
                        </div>
                  ...
                  <div class="card mb-3">
                    <div class="card-body">
                      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="true">
                        ...
                        <div class="carousel-inner">
                          <div class="carousel-item active">
                            <img src="assets/images/products/product9.jpg" class="d-block w-100"
                              alt="Bootstrap Gallery">
                          </div>
                          <div class="carousel-item">
                            <img src="assets/images/products/product2.jpg" class="d-block w-100"
                              alt="Bootstrap Gallery">
                          </div>
                          <div class="carousel-item">
                            <img src="assets/images/products/product5.jpg" class="d-block w-100"
                  ...
                  <div class="card mb-3">
                    <div class="card-body">
                      <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="false">
                        ...
                        <div class="carousel-inner">
                          <div class="carousel-item active">
                            <img src="assets/images/products/product10.jpg" class="d-block w-100"
                              alt="Bootstrap Gallery">
                          ...
                          <div class="carousel-item">
                            <img src="assets/images/products/product4.jpg" class="d-block w-100"
                              alt="Bootstrap Gallery">
                            <div class="carousel-caption d-none d-md-block">
                          ...
                          <div class="carousel-item">
                            <img src="assets/images/products/product3.jpg" class="d-block w-100"
                              alt="Bootstrap Gallery">
                            <div class="carousel-caption d-none d-md-block">
